...
import { LayoutDashboard, Users, Award, ShieldCheck, Flag, Newspaper, ArrowLeft, Puzzle, Swords, Video, Music2, Spade } from "lucide-react";
...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const links = [
    ...
    { href: "/admin/ads",     icon: Video,         label: "Ads"     },
    { href: "/admin/sounds",  icon: Music2,        label: "Sounds"  },
    { href: "/admin/rooms",   icon: Swords,        label: "Rooms"   },
    { href: "/admin/durak",   icon: Spade,         label: "Durak"   },
  ];
