  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 mb-10">
      {Array.from({ length: 5 }).map((_, i) => (
        <div key={i} className="bg-[var(--bg-card)] border border-[var(--border-subtle)] rounded-xl p-5 flex flex-col gap-3 animate-pulse">
          <div className="w-9 h-9 rounded-lg bg-[var(--bg-elevated)]" />
          <div>
            <div className="h-7 w-12 rounded bg-[var(--bg-elevated)] mb-1" />
