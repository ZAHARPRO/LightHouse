 ...
 */
final class Version20251216175411 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE feed_video (feed_id INT NOT NULL, video_id INT NOT NULL, INDEX IDX_8948899051A5BC03 (feed_id), INDEX IDX_8948899029C1004E (video_id), PRIMARY KEY(feed_id, video_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
